...
*/
let FirstSixChar = quote.slice(0, 6).split('').forEach((item, index) => console.log(`The character at index ${index} is ${item}`));
 /*
...
*/
console.log(quoteSplitted["tomorrow"] === "today")
/*
12. Find the index of second "o" in quote. Use indexOf
*/
console.log(quote.indexOf('0'));
/*
